<?php $this->load->view('page/header') ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="active"><i class="fa fa-tasks fa-fw"></i> Tambah Data Hari</li>
            ...
            <div class="row">
                <div class="col-lg-11">
                    <?=form_open_multipart('web/add_hari/',['class'=>'form-horizontal'])?>

                        <?php $error = form_error("nama_hari", "<p class='text-danger'>", '</p>'); ?>
                        <div class="form-group <?php echo $error ? 'has-error' : '' ?>">
                            <label class="col-sm-2 control-label">Nama Hari</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_hari" value="<?= set_value('nama_hari') ?>">
                            </div>
                        </div>
                        <?php echo $error; ?>
